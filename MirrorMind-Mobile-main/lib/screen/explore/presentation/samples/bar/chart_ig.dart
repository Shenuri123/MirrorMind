...
class Instagram extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => InstagramState();
}

class InstagramState extends State<Instagram> {
  late Stream<List<double>> weeklyInstagramDataStream;

  @override
  void initState() {
    super.initState();
    weeklyInstagramDataStream = getInstagramDataAsStream();
  }

  Stream<List<double>> getInstagramDataAsStream() async* {
  ...
  Widget build(BuildContext context) {
    return AspectRatio(
      ...
      child: StreamBuilder<List<double>>(
        stream: weeklyInstagramDataStream,
